...
import { 
  Search, Plus, Minus, Trash2, User, Banknote, RotateCcw, ShoppingCart, 
  Image as ImageIcon, CheckCircle, AlertCircle, X, AlertTriangle, Edit2, 
  Check, Package
} from 'lucide-react';
      ...
      <div className="w-96 bg-white flex flex-col shrink-0 shadow-xl z-20 border-l border-slate-100">
        ...
        <div className="p-5 border-b border-slate-100 bg-white">
          ...
          <div className="relative">
            ...
            <select 
              className="w-full pl-10 pr-4 py-2.5 bg-[#F1F8F4] border border-slate-200 rounded-xl text-sm focus:outline-none focus:border-[#1B5E20] focus:ring-2 focus:ring-[#1B5E20]/20 appearance-none font-medium text-slate-700"
              value={customer?.id || ''}
              onChange={(e) => {
